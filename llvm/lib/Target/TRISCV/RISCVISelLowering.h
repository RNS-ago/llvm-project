...
#include <optional>
#include "../TRISCV/RISCV.h"
#include "../TRISCV/RISCVCallingConv.h"
...
private:
  ...
  SDValue lowerCAST(SDValue Op, SelectionDAG &DAG) const;
  unsigned getTypeTag(EVT VT, bool IsSigned) const;
