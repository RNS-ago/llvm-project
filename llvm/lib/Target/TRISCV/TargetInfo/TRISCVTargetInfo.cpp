...
#include "../../TRISCV/TargetInfo/RISCVTargetInfo.h"
...
LLVMInitializeTRISCVTargetInfo() {
  ...
  RegisterTarget<Triple::triscv64, /*HasJIT=*/true> Y(
      getTheRISCV64Target(), "triscv64", "My 64-bit Tagged RISC-V", "TRISCV");
}
